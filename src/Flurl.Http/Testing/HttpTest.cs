...
namespace Flurl.Http.Testing
{
    ...
    public class HttpTest : IDisposable
    {
        ...
        public List<HttpCallSetup> Setups { get; }
        ...
        /// <summary>
        /// Configures a call setup that will return the response if the setups match.
        /// </summary>
        /// <param name="content">The simulated response body content (optional).</param>
        /// <param name="status">The simulated HTTP status. Default is OK 200.</param>
        /// <param name="headers">The simulated response headers (optional).</param>
        /// <param name="cookies">The simulated response cookies (optional).</param>
        /// <param name="replaceUnderscoreWithHyphen">If true, underscores in property names of headers will be replaced by hyphens. Default is true.</param>
        /// <returns>An HttpCallSetup object to allow setup.</returns>
        public HttpCallSetup ShouldRespondWith(HttpContent content = null, HttpStatusCode status = HttpStatusCode.OK, object headers = null, object cookies = null, bool replaceUnderscoreWithHyphen = true)
        {
            var response = new HttpResponseMessage
            {
                StatusCode = (HttpStatusCode)status,
            ...
            var setup = new HttpCallSetup(response);
            Setups.Add(setup);
