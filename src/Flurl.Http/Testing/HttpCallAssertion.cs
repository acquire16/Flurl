...
namespace Flurl.Http.Testing
{
    ...
    public class HttpCallAssertion
    {
        ...
        public HttpCallAssertion WithUrlPattern(string urlPattern)
        {
            ...
            return With(c => CallAssertionHelpers.MatchesPattern(c.FlurlRequest.Url, urlPattern));
        }
        ...
        public HttpCallAssertion WithQueryParamValue(string name, object value)
        {
            ...
            return With(c => c.FlurlRequest.Url.QueryParams.Any(qp => CallAssertionHelpers.QueryParamMatches(qp, name, value)));
        }
        ...
        public HttpCallAssertion WithoutQueryParamValue(string name, object value)
        {
            ...
            return Without(c => c.FlurlRequest.Url.QueryParams.Any(qp => CallAssertionHelpers.QueryParamMatches(qp, name, value)));
        }
        ...
        public HttpCallAssertion WithRequestBody(string bodyPattern)
        {
            ...
            return With(c => CallAssertionHelpers.MatchesPattern(c.RequestBody, bodyPattern));
        }
    ...
    internal class CallAssertionHelpers
    {
        public static bool QueryParamMatches(QueryParameter qp, string name, object value)
        {
            if (qp.Name != name)
                return false;
            if (value is string s)
                return CallAssertionHelpers.MatchesPattern(qp.Value?.ToString(), s);
            return qp.Value?.ToString() == value?.ToString();
        }

        public static bool MatchesPattern(string textToCheck, string pattern)
        {
